      ...
      <div class="flex justify-between items-center h-16 px-10 max-w-[1280px] mx-auto">
        ...
        <nav class="hidden md:flex items-center gap-8">
          ...
          <div class="relative group">
            <input class="pl-10 pr-4 py-2 bg-[#f3f3fe] rounded-full border-none focus:ring-2 focus:ring-[#004ac6] text-sm w-64 transition-all" placeholder="Search treasures..." type="text"/>
            <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#737686] text-sm">search</span>
          </div>
        </nav>
        <div class="flex items-center gap-6">
          ...
          <button type="button" class="bg-[#004ac6] text-white px-6 py-2.5 rounded-lg font-semibold text-sm hover:opacity-90 transition-all active:scale-95">Donate</button>
          <div class="w-10 h-10 rounded-full overflow-hidden border-2 border-[#dbe1ff]" data-profile-trigger>
            <img alt="User avatar" data-alt="A professional headshot of a friendly individual with a warm smile, set against a soft-focus office background." src="${DEFAULT_AVATAR}" class="w-full h-full object-cover" />
          </div>
        </div>
      </div>
    </header>
    ...
    <footer class="bg-slate-50 dark:bg-slate-950 w-full py-16 border-t border-slate-200 dark:border-slate-800" style="background-color: #f8fafc;">
      <div class="max-w-[1280px] mx-auto px-10 flex flex-col md:flex-row justify-between items-start gap-12 font-manrope text-sm leading-relaxed">
        <div class="max-w-sm">
          ...
          <div class="flex gap-4">
            <a class="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center hover:bg-[#004ac6] hover:text-white transition-all" style="background-color: #e2e8f0; color: #191b23;" href="#">
